...
public class appliMain01 {
    ...
    public static void main(String[] args) {
        ...
        EtatProduit ep01 = new EtatProduit("Mis en vente");
        EtatProduit ep02 = new EtatProduit("Stand-by");

        EtatVente ev01 = new EtatVente("En cours");
        EtatVente ev02 = new EtatVente("Terminée");
        //--------------- les associations -----
        ...
        v01.setEtatVente(ev01);
        v02.setEtatVente(ev02);
        ...
        EtatProduit epp01 = em.find(EtatProduit.class,1L);
        EtatVente evv01 = em.find(EtatVente.class,1L);
        System.out.println("=================================================\n");
        ...
        System.out.println("L'état-vente d'une vente : " + vv01.getEtatVente());
        System.out.println("La vente d'un utilisateur : " + uu01.getVentes());
        System.out.println("L'enchere d'une vente : " + v01.getEncheres());
        System.out.println("Le produit d'une  : " + vv01.getEncheres());
        System.out.println("\n=================================================");
